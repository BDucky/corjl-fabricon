...
export const BUNDLED_MODELS: ModelInfo[] = [
  {
    ...
    name: 'Coffee Mug',
    url: '/models/mug.glb',
    thumbnailUrl: '/images/thumb-mug.png',
    targetMeshNames: ['body', 'Body', 'mug_body', 'Mug_Body'],
    bundled: true,
  },
  {
    id: 'box',
    name: 'Product Box',
    url: '/models/box.glb',
    thumbnailUrl: '/images/thumb-box.png',
    targetMeshNames: ['front', 'Front', 'box_front', 'Box_Front', 'side', 'Side'],
    bundled: true,
  },
]
